...
export default function TitleArticles() {
    return (
        <Head>
            ...
            <title>Articles by Sreeraksha M R</title>
            <meta name="description" content="Explore articles authored by Sreeraksha M R, a Full Stack Engineer and Developer." />
