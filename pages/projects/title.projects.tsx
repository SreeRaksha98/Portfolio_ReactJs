...
export default function TitleProjects() {
    return (
        <Head>
            ...
            <meta name="description" content="Explore a collection of my Open Source projects by Sree Raksha M R, showcasing a range of technology and development endeavors." />
