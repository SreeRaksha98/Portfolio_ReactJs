        ...
        <Section classProp={about.section}>
            <Container spacing={['verticalXLrg']}>
                <SectionTitle
                    ...
                    subTitle=""
                />
                <div className={`${about.edu} min-h-screen flex items-center justify-center rounded-2xl`}>
                    <div className="flex flex-col md:grid grid-cols-9 mx-auto p-8">
                        {/* Start */}
                        <div className="flex flex-row-reverse md:contents">
                            <div className={`${about.eachEdu} w-full col-start-1 col-end-5 p-4 rounded-xl my-4 ml-auto border border-gray-300`}>
                                <h3 className="font-semibold text-xl mb-1">2013</h3>
                        ...
                        <div className="flex md:contents">
                            ...
                            {/* End	 */}
                            <div className={`${about.eachEdu} w-full col-start-6 col-end-10 my-4 mr-auto p-4 border border-gray-300 rounded-xl`}>
                                <h3 className="font-semibold text-xl mb-1">2013-2015</h3>
                        ...
                        <div className="flex flex-row-reverse md:contents">
                            <div className={`${about.eachEdu} w-full col-start-1 col-end-5 p-4 rounded-xl my-4 ml-auto border border-gray-300`}>
                                <h3 className="font-semibold text-xl mb-1">2015-2019</h3>
                        ...
                        <div className="flex md:contents">
                            ...
                            <div className={`${about.eachEdu} w-full col-start-6 col-end-10 my-4 mr-auto p-4 border border-gray-300 rounded-xl`}>
                                <h3 className="font-semibold text-xl mb-1">2020-2021</h3>
                        ...
                        <div className="flex flex-row-reverse md:contents">
                            <div className={`${about.eachEdu} w-full col-start-1 col-end-5 p-4 rounded-xl my-4 ml-auto border border-gray-300`}>
                                <h3 className="font-semibold text-xl mb-1">2019-2021</h3>
                        ...
                        <div className="flex md:contents">
                            ...
                            <div className={`${about.eachEdu} w-full col-start-6 col-end-10 my-4 mr-auto p-4 border border-gray-300 rounded-xl`}>
                                <h3 className="font-semibold text-xl mb-1">2021-current</h3>
                                <div className="text-gray-600">
